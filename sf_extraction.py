...
def getCurrDatetime():
	"""
	Get the current datetime - for logging the process time
	"""
...
def ExtractData(table_name):
	...
	"""
	logging.info('Data Extraction Starts for Table: {} at {} ...'.format(table_name, getCurrDatetime()))
	print('Data Extraction Starts for Table: {} at {} ...'.format(table_name, getCurrDatetime()))
	try:
		...
		if int(rec_count) == 0:
			...
			logging.info('Data has been extrcated as {} at {} \n\n'.format(extract_file, getCurrDatetime()))
